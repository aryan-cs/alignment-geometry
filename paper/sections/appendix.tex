...
\caption{Leave-one-seed-out separation across three families. Each direction is
fitted on the remaining seeds; the held-out misaligned arm scores higher in all
$12/12$ folds (descriptive 95\% Wilson interval $[75.8,100.0]\%$), while an
equal-dimensional random direction scores both arms near $0.015$.}
\label{fig:detect}
\end{figure}
