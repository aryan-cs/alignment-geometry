...
blue/orange height is final-direction cosine/measured-misalignment rate. Cosine
reaches $0.84$ at $20\%$ and $0.99$ by $60\%$; the rate peaks at $80\%$.
\emph{Right:} the same directions in PCA coordinates. Labels and line give
training order, color gives rate, and proximity means similarity; axis signs and
orientation are arbitrary. Step $0$ is the base model, and both views are
retrospective.}
\label{fig:traj}
\end{figure}
