...
eligible sample shows that the intervention is already degrading response
coherence. Of $800$ outputs per setting, the eligibility rates are $84.6\%$
...
$60\%$, before the all-output joint rate peaks at $80\%$
($24/384=6.25\%$, $[4.2,9.1]\%$) and falls at the final checkpoint
($15/384=3.91\%$, $[2.4,6.3]\%$; Figure~\ref{fig:traj} in
Appendix~\ref{app:details}). The corresponding eligible-output rates are
$7.4\%$ and $4.7\%$. Because the
