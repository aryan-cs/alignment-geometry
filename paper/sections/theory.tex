...
BBP-type threshold $\theta_\star=\sqrt{\gamma}$ a planted signal is not separated
from the limiting Marchenko--Pastur bulk by this criterion; above it the
...
reference; variance-matched Gaussian control \\
