...
has no MP-visible leading values (Figure~\ref{fig:nullcompare}). The Gaussian control
...
plus six finite-size scales. Every layer has visible structure. These counts depend on the fitted visibility threshold
