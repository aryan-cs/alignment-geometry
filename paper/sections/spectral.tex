...
inflated by the spikes, still places every leading eigenvalue above the edge and
gives a median top-to-edge ratio of $11.8$. The number of exceedances changes
substantially, so we treat that count as fit-dependent
