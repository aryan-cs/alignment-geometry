...
fixes one recipe; we did not run matched controls for coding, mathematics,
other domains, or objectives such as RLHF and DPO
\citep{ouyang2022instruct,rafailov2023dpo}, nor for other optimizers or
schedules. Reasoning,
mixture-of-experts, multimodal, and models beyond 14B remain outside scope.
...
ranking screen, not a held-out causal intervention. Missing medical training
rows prevent independent retraining. The refusal direction may encode prompt
distribution, topic, or style alongside refusal. HarmBench reproduces the spectral-versus-random gap on
held-out harmful prompts \citep{mazeika2024harmbench}, but harmless prompts,
adaptive attacks, and human scoring remain untested. Projection is blunt and
...
Naturally occurring deception, sycophancy, reward hacking, jailbreaks, and
multimodal failures remain untested. Prospective use requires directions and
