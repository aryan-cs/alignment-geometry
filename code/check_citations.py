...
PAPER_METADATA_SENTINELS = {
    ...
    "betley2025emergent": ("Emergent Misalignment", "42nd International Conference on Machine Learning", "4043--4068", "2025"),
    ...
    "mazeika2024harmbench": ("HarmBench", "41st International Conference on Machine Learning", "35181--35224", "2024"),
    "templeton2024scaling": ("Scaling monosemanticity", "Transformer Circuits Thread", "2024"),
    "fierro2026weight": ("Steering Language Models with Weight Arithmetic", "International Conference on Learning Representations", "arXiv:2511.05408", "2026"),
    "shuttleworth2025lora": ("{LoRA} vs Full Fine-tuning", "Advances in Neural Information Processing Systems", "38", "2025"),
    "wei2024brittleness": ("Assessing the Brittleness of Safety Alignment", "41st International Conference on Machine Learning", "52588--52610", "2024"),
    "hsu2024safelora": ("Safe {LoRA}", "Advances in Neural Information Processing Systems", "10.52202/079017-2078", "2024"),
    "zhou2025lssf": ("{LSSF}", "63rd Annual Meeting of the Association for Computational Linguistics", "10.18653/v1/2025.acl-long.1479", "2025"),
    "zhang2026preserving": ("Understanding and Preserving Safety", "arXiv:2601.10141", "2026"),
    "staats2024small": ("Small singular values matter", "Advances in Neural Information Processing Systems", "38", "2025"),
    ...
    "larf2025": ("Layer-Aware Representation Filtering", "Empirical Methods in Natural Language Processing", "8030--8050", "10.18653/v1/2025.emnlp-main.406", "2025"),
    ...
    "rafailov2023dpo": ("Direct Preference Optimization", "Advances in Neural Information Processing Systems", "53728--53741", "2023"),
    ...
    "kirkpatrick2017": ("Overcoming catastrophic forgetting", "Proceedings of the National Academy of Sciences", "10.1073/pnas.1611835114", "2017"),
    "merchant2020": ("What Happens To {BERT} Embeddings", "Third BlackboxNLP Workshop", "10.18653/v1/2020.blackboxnlp-1.4", "2020"),
    "yu2020gradient": ("Gradient Surgery for Multi-Task Learning", "Advances in Neural Information Processing Systems", "2020"),
...
PROOF_METADATA_SENTINELS = {
    ...
    "edelman1998": ("The geometry of algorithms with orthogonality constraints", "SIAM J. Matrix Anal. Appl.", "10.1137/S0895479895290954", "1998"),
    ...
    "staats2024": ("Small singular values matter", "\\emph{NeurIPS}", "vol.~38", "2025"),
    "roy2007": ("The effective rank", "European Signal Processing Conference", "2007"),
    "grattafiori2024": ("The Llama 3 herd of models", "arXiv:2407.21783", "2024"),
    "betley2025": ("Emergent misalignment", "PMLR~267:4043--4068", "2025"),
    ...
    "wang2025persona": ("Persona features control emergent misalignment", "\\emph{ICLR}", "2026", "arXiv:2506.19823"),
    "chen2025": ("Persona vectors: monitoring and controlling character traits", "arXiv:2507.21509"),
    "larf2025": ("Layer-aware representation filtering", "\\emph{EMNLP}", "8030--8050", "10.18653/v1/2025.emnlp-main.406"),
    "ettori2026": (
    ...
    "bailey2024": ("Obfuscated activations bypass LLM latent-space defenses", "\\emph{ICLR}", "2026", "arXiv:2412.09565"),
...
PAPER_CONTEXT_SENTINELS = [
    ("paper/sections/abstract.tex", "directions associated with refusal", ("ouyang2022instruct", "arditi2024"), 2),
    ...
    ("paper/sections/abstract.tex", "measured emergent misalignment", ("betley2025emergent", "turner2025organisms"), 2),
    ("paper/sections/abstract.tex", "Qwen2.5-Coder-7B-Instruct intervention", ("hui2024qwen25coder",), 2),
    ("paper/sections/abstract.tex", "Mistral-7B", ("jiang2023mistral",), 2),
    ("paper/sections/intro.tex", "preference optimization, or safety training", ("ouyang2022instruct", "rafailov2023dpo"), 2),
    ("paper/sections/intro.tex", "released Llama-3-8B Base-to-Instruct", ("grattafiori2024llama3",), 2),
    ("paper/sections/intro.tex", "Under an iid Gaussian diffuse-update", ("marchenko1967", "johnstone2001"), 3),
    ("paper/sections/intro.tex", "additive fixed-rank model", ("benaych2012",), 4),
    ("paper/sections/intro.tex", "singular vector partially overlaps", ("benaych2012",), 3),
    ("paper/sections/intro.tex", "seeded random subspace gives", ("wilson1927",), 2),
    ("paper/sections/intro.tex", "emergent-misalignment model-organism setting", ("betley2025emergent", "turner2025organisms"), 2),
    ("paper/sections/spectral.tex", "Llama-3-8B", ("grattafiori2024llama3",), 1),
    ("paper/sections/spectral.tex", "generic training variation", ("aghajanyan2021", "hu2022lora"), 2),
    ("paper/sections/spectral.tex", "query/key maps set attention patterns", ("vaswani2017attention",), 2),
    ...
    ("paper/sections/causal.tex", "on MMLU,", ("hendrycks2021mmlu", "cobbe2021gsm8k", "clark2018arc"), 3),
    ("paper/sections/misalignment.tex", "model-organism", ("turner2025organisms",), 2),
    ("paper/sections/misalignment.tex", "On a Qwen2.5-Coder-14B", ("hui2024qwen25coder",), 2),
    ...
    ("paper/sections/appendix.tex", "fixed phrase list defined", ("code/causal.py", "arditi2024"), 4),
    ("paper/sections/appendix.tex", "Data manifest:", ("results/data/analysis_manifest.json",), 4),
    ...
    ("paper/sections/related.tex", "top-ranked", ("larf2025",), 2),
    ("paper/sections/related.tex", "intruder dimensions", ("shuttleworth2025lora",), 2),
    ("paper/sections/related.tex", "contrastive weight steering", ("fierro2026weight",), 2),
    ("paper/sections/related.tex", "safety-critical neuron- and rank-level", ("wei2024brittleness",), 2),
    ("paper/sections/related.tex", "projects LoRA updates onto", ("hsu2024safelora",), 2),
    ("paper/sections/related.tex", "LSSF extracts", ("zhou2025lssf",), 2),
    ("paper/sections/related.tex", "safety-preserving fine-tuning removes", ("zhang2026preserving",), 2),
    ("paper/sections/related.tex", "catastrophic forgetting", ("kirkpatrick2017",), 2),
    ("paper/sections/related.tex", "task adaptation can reorganize", ("merchant2020",), 2),
    ("paper/sections/related.tex", "gradient interference", ("yu2020gradient",), 2),
    ("paper/sections/discussion.tex", "matched controls for domain adaptation", ("ouyang2022instruct", "rafailov2023dpo"), 3),
    ("paper/sections/discussion.tex", "provenance-complete HarmBench run", ("mazeika2024harmbench",), 2),
    ...
    ("paper/sections/discussion.tex", "Top-$128$ ablation substantially degrades MMLU", ("hendrycks2021mmlu", "cobbe2021gsm8k", "clark2018arc"), 3),
    ("paper/sections/em_examples.tex", "Qwen2.5-7B-Instruct judge scores", ("yang2024qwen25", "betley2025emergent"), 3),
]

DOCUMENT_CONTEXT_SENTINELS = [
    ("docs/proof.tex", "additive rectangular singular-value transition", ("benaych2012",), 2),
    ("docs/proof.tex", "classical Baik--Ben~Arous--P\\'ech\\'e", ("bbp2005", "baik2006", "paul2007"), 3),
    ("docs/proof.tex", "Marchenko--Pastur bulk", ("marchenko1967",), 2),
    ("docs/proof.tex", "Tracy--Widom null", ("tracywidom1996", "johnstone2001"), 2),
    ("docs/proof.tex", "Supervised white-box probes can read deception", ("goldowskydill2025",), 3),
    ("docs/proof.tex", "the three teams with", ("marks2025",), 5),
    ...
    ("docs/proof.tex", "random-matrix hallucination detectors", ("ettori2026",), 2),
    ("docs/proof.tex", "related work connects weight spectra", ("staats2024",), 3),
    ("docs/proof.tex", "lineage detection", ("ghost2026",), 2),
    ...
    ("docs/proof.tex", "Leading-subspace principal-angle distance", ("edelman1998",), 2),
    ("docs/proof.tex", "released Llama-3-8B architecture", ("grattafiori2024",), 3),
...
def check_bib_field_values(errors, key, entry):
    ...
    for field in ("journal", "booktitle", "howpublished", "note"):
        ...
        for arxiv_year, _ in ARXIV_ID_RE.findall(value):
            # A preprint can legitimately precede its final conference publication.
            # It cannot, however, postdate the publication year recorded by the entry.
            arxiv_full_year = 2000 + int(arxiv_year[:2])
            if year and int(year.strip()) < arxiv_full_year:
                errors.append(
                    f"paper refs.bib entry {key} has arXiv id {arxiv_year} after year {year.strip()}"
                )
