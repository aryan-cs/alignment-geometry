...
PAPER_CONTEXT_SENTINELS = [
    ...
    ("paper/sections/abstract.tex", "rectangular", ("benaych2012",), 2),
    ...
    ("paper/sections/abstract.tex", "In the Qwen2.5-Coder", ("hui2024qwen25coder",), 2),
    ...
    ("paper/sections/spectral.tex", "The sweep and", ("results/data/spectral.jsonl", "code/spectral.py"), 4),
    ...
    ("paper/sections/causal.tex", "MMLU, GSM8K, and ARC-style", ("hendrycks2021mmlu", "cobbe2021gsm8k", "clark2018arc"), 2),
    ("paper/sections/causal.tex", "Artifacts are", ("results/data/behavioral_capture.json", "results/data/capture_sweep.json", "results/data/ablation_sweep.json", "results/data/ablation_layers.json", "results/data/sufficiency.json"), 8),
    ...
    ("paper/sections/misalignment.tex", "Evaluation outputs are in", ("results/data/misalignment_eval_medical.json",), 2),
    ("paper/sections/misalignment.tex", "seeds, or model families. Results are in", ("results/data/directions_med.json", "results/data/causal_misalign.json", "results/data/detect_med.json"), 4),
    ("paper/sections/misalignment.tex", "a noisier estimate.", ("results/data/directions_llama.json", "results/data/directions_mistral.json", "results/data/causal_misalign_llama.json", "results/data/causal_misalign_mistral.json", "results/data/detect_llama.json", "results/data/detect_mistral.json"), 8),
    ...
    ("paper/sections/related.tex", "recover a convergent linear direction from model", ("soligo2025convergent",), 2),
