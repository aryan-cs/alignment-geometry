...
PAPER_CONTEXT_SENTINELS = [
    ...
    ("paper/sections/intro.tex", "idealized iid Gaussian diffuse-update model", ("marchenko1967", "johnstone2001"), 3),
    ("paper/sections/intro.tex", "rectangular-perturbation threshold", ("benaych2012",), 3),
    ("paper/sections/intro.tex", "associated singular vectors estimate", ("benaych2012",), 2),
    ...
    ("paper/sections/discussion.tex", "HarmBench OOD run with complete prompt provenance", ("mazeika2024harmbench",), 2),
    ("paper/sections/discussion.tex", "The BBP-type threshold", ("baik2005", "benaych2012"), 2),
    ("paper/sections/discussion.tex", "refusal analysis uses one released model", ("grattafiori2024llama3",), 2),
    ("paper/sections/discussion.tex", "low intrinsic dimension of fine-tuning", ("hu2022lora", "aghajanyan2021"), 2),
    ("paper/sections/discussion.tex", "MMLU, ARC-C, and GSM8K evaluations", ("hendrycks2021mmlu", "cobbe2021gsm8k", "clark2018arc"), 3),
