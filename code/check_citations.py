...
PAPER_CONTEXT_SENTINELS = [
    ("paper/sections/abstract.tex", "Post-training can turn", ("ouyang2022instruct", "arditi2024"), 2),
    ...
    ("paper/sections/abstract.tex", "detached spikes", ("benaych2012",), 2),
    ...
    ("paper/sections/abstract.tex", "emergent-misalignment model-organism setting", ("betley2025emergent", "turner2025organisms"), 2),
    ...
    ("paper/sections/discussion.tex", "BBP-type threshold separates outlier singular values", ("baik2005", "benaych2012"), 2),
...
DOCUMENT_CONTEXT_SENTINELS = [
    ...
    ("docs/proof.tex", "all three teams with model-and-data access succeeded", ("marks2025",), 3),
